...
<section class="intro">
   Давным давно,<br>
в далекой далекой галактике...<br>Миллионы символов овладели<br> Одним junым подаваном.<br> И содрогнулось мироздание<br>Пред мощью его бесполезности, но...
</section>
<section class="logo">
  ...
  <div id="content">
    ...
    <p id="subtitle">Начало пути</p>
    <br>
    <!-- And make it cheesy ! -->
    <p>Шел 31 год от создания Первого Браузера.
Ровно 26 лет назад появилась сила.
Темный и хтонический высокоуровневый язык программирования.
Его имя JavaScript.
Магия вложенная в него может пожрать вселенную.
Тысячи странцев изничтожали миллионы клавиатур, дабы познать -"да что не так то?"
Как женские слезы, JavaScript ставил в тупик лучших
Как пьяный отчим жесток для Junior-Dev
Сколько фреймворков стоит победить ради места под солнцем?
Сколько тысяч киллометров кода придется написать?
Я знаю отца породившего это чудовище, но смогу ли я быть достойным сыном Его..?</p>        
   
  </div> 
</div>
   </div>
   <!--Я намеренно не стал выравнивать с помощью translate -->
   <p
    id="end">Вступление закончено!<br>Спасибо вам за внимание</p>
</template>
